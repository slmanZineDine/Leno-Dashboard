...
import {
  addSupervisorSchema,
  type TAddSupervisorForm,
} from "@validation/user/supervisor/addSupervisorSchema";
...
const AddSupervisor = () => {
  ...
  return (
    <>
      {/* ========================== Main Heading ========================== */}
      <HeadingSection title={t(pathTitleMap["add-supervisor"])} />
