...
// Validation
import {
  type TUpdateAdminForm,
  updateAdminSchema,
} from "@validation/user/admin/updateAdminSchema";
...
const EditAdminProfile = () => {
  ...
  } = useForm<TUpdateAdminForm>({
    mode: "onBlur",
    resolver: zodResolver(updateAdminSchema()),
  });

  // ################### ASYNC REQUEST ###################
  const onSubmit: SubmitHandler<TUpdateAdminForm> = async (data) => {
    try {
      ...
      navigate(paths.adminProfile.root, { replace: true });
    } catch (err) {
      console.log(err);
    }
  };
